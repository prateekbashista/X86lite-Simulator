...
(*Custom Set CC Test*)
let setb = test_machine
    [InsB0 (Movq, [~$4095; ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
    ;InsB0 (Movq, [~$4095; ~%Rbx]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
    ;InsB0 (Cmpq,[~%Rbx; ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
    ;InsB0 (Set Eq, [~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
    ]
...
let instruction_tests = [
  ...
  (*Custom machine for setb test*)
  ("setb", machine_test "rax=0xF01L *65528=2" 4 setb
  (fun m -> m.regs.(rind Rax) = 0xF01L)
  );
